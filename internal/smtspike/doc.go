...
// github.com/pokt-network/smt as the state-root keystone.
//
// The library call recommends the library on DOCUMENTARY evidence — quoted
// source, not executed code. This package is the executed half. It carries no
// product code and is imported by nothing: the dependency lives behind these
// tests until the keystone build lands.
//
