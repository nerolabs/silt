...
7. **ANSWERED 2026-09-12 — YES, and a chainless client carries 32 BYTES**
   ...
   **SUPPLY ROUTE BUILT 2026-09-13 — route (a) only, and the CONSUMER is still #828.** `swarm add`
   ...
   `cmd/silt TestDeclareNetworkIdentityIsBehaviouralAndOnTheLoop` drives for real, and the residual
   that no source gate of this shape can close is filed as `R-CHAINID-INSTALL-SOURCE-GATED`.
