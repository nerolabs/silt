...
**▶ UPDATE 2026-09-11 — M1, the single genesis move, is BUILT AND HELD** on
`builder/m1-genesis-move`, not merged: it is a FORMAT item and the owner reviews those
individually (`D-M1-GENESIS-MOVE-2026-09-11`). It carries owner call A's preimage, owner call F's
bind, `ConsensusParams.NetworkName` at cbor key 18, and the two era-activation daemon flags
defaulting to 1/1.
