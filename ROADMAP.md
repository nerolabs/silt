...
- **Crash-safety: torn `chain.cbor` → silent genesis fallback — #558.** **CLOSED 2026-09-07 (Lane B8, scope call S3): fsync'd atomic write + refuse-to-start unless `-accept-chain-loss`.** History: a SIGKILL mid-persist
