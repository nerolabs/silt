...
// detector — a judge that pays a repair bounty to ITSELF.
//
...
// the A4 self-dealing shape (canary abort, HARD).
//
// ABLATION run RED before this shipped: counting every release
