...
// d. This pins it: a store holding cap+1 records is refused at load, by name.
...
// A record carrying another key's fingerprint refuses the boot by name; unbound
// (zero Server) records are tolerated.
