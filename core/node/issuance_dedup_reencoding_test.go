...
// serial, and without it the issuer charges twice. A re-encoding therefore bought a
// second charge for one issuance.
//
...
func TestReEncodedBlindCannotBypassTheIssuanceDedup(t *testing.T) {
	const fee = 100
