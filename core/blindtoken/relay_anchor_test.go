...
// relayAnchorDomainLiteral is the format constant, written out here
// INDEPENDENTLY of the implementation so the pin is against the research, not
// against whatever the code happens to say.
