...
//
// ⚠ NOT CHAIN-BOUND, AND IT IS THE ONE EXCEPTION IN THIS FILE. The other
...
// v2 BINDS THE CHAIN ID INTO THE SIGNED MESSAGE — see chainBoundMsg.
...
// v3 BINDS THE CHAIN ID, by exactly the move v2 made for the epoch:
...
// an edit.
// v2 BINDS THE CHAIN ID, the same message extension the demand domain
