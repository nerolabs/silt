...
// mode, and the failure this gate is most likely to miss, because an economy in which
// nobody can afford to transact reads solvent.
//
// FLOOR DETECTOR ONLY: non-zero proves honest demand is being refused somewhere and can
// abort a canary; zero proves NOTHING — an adversary inflates the number at will by
// presenting underfunded identities.
//
// ABLATION run RED before this shipped: counting the distinct
