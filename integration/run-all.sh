...
SUITES_CATALOG=(
  "consensus|gate|900|Objective bond-weighted commit admission: a sub-quorum partition commits nothing, stalls, and catches up to the majority history on heal"
