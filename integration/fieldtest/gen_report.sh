...
md.append("---\n")
md.append("_Generated by `integration/fieldtest`. The field network is ephemeral and was torn down after this run._")
open(out_md, "w").write("\n".join(md))
...
<p class="meta">Generated by <code>integration/fieldtest</code>. The field network is ephemeral and was torn down after this run.</p>
</body></html>"""
